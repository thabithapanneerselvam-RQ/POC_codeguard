...
// const GEMINI_KEY = 'AIzaSyAkaDWJ5Oosylc2CeOg2quV7S1BF_2ekx0';
...
//     console.log(`  Fix before:  ${(gemini.fix?.before || '')}`)
//     console.log(`  Fix after:   ${(gemini.fix?.after  || '')}\n`)
...
//     console.log(`   Confidence:   ${conf.level} (${conf.score}/100)`)
//     console.log(`   Explanation:  ${r.gemini.explanation?.substring(0, 100)}...`)
//     console.log(`   Fix before:   ${(r.gemini.fix?.before || '')}`)
//     console.log(`   Fix after:    ${(r.gemini.fix?.after  || '')}`)
...
const GEMINI_KEY = 'AIzaSyDbFoL1mMe_2Yh2hG-7bFBD07eJyiVQx28'
